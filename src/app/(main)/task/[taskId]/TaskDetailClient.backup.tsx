                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6 flex flex-col">
                        <div className="flex items-center mb-4 sm:mb-6">
                            ...
                            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Comentários</h2>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6">
                        <div className="flex items-center mb-4 sm:mb-6">
                            ...
                            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Histórico</h2>
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 xs:px-4 sm:px-4 lg:px-8">
                    ...
                    {/* DESKTOP HEADER (≥ sm) - ESTILO MINIMALISTA */}
                    ...
                    {/* Estatísticas - ESTILO MINIMALISTA */}
                    <div className="mt-6">
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:hidden">
                            ...
                            <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-center min-h-[80px] flex flex-col justify-center">
                                ...
                                <div className="text-xs text-gray-600 mt-1">{formData.status === 'completed' ? 'Concluída' : 'Pendente'}</div>
                            </div>
                            
                            {/* Comentários */}
                            <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-center min-h-[80px] flex flex-col justify-center">
                                <div className="text-2xl font-bold text-gray-900">{formData.comments?.length || 0}</div>
                                <div className="text-xs text-gray-600 mt-1">Comentários</div>
                            </div>
                            
                            {/* Data de Vencimento / Horário / Recorrência - Card dinâmico */}
                            {formData.dueDate ? (
                                <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-center min-h-[80px] flex flex-col justify-center">
                                ...
                                <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-center min-h-[80px] flex flex-col justify-center">
                                    ...
                                    <div className="text-xs text-gray-600 mt-1">Horário</div>
                                </div>
                            ) : formData.isRecurring && formData.recurrence ? (
                                <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-center min-h-[80px] flex flex-col justify-center">
                        ...
                        <div className="hidden sm:grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                            ...
                            <div className="bg-white border border-gray-200 rounded-xl p-4 text-center shadow-sm">
                                <div className="text-2xl font-bold">{formData.status === 'completed' ? '✅' : '⏳'}</div>
                                <div className="text-sm text-gray-600">{formData.status === 'completed' ? 'Concluída' : 'Pendente'}</div>
                            </div>
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6">
                                    <div className="flex items-center mb-3 sm:mb-0">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 dark:text-gray-400 sm:hidden">Links úteis relacionados à tarefa</p>
                                        </div>
                                    </div>
                                    <div className="hidden sm:block text-xs text-gray-500 dark:text-gray-400">
                                        Links úteis relacionados à tarefa
                                    </div>
                                </div>
